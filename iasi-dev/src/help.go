...
func printHelp() {
	...
	Usage:
	  ...
	  iasi-dev version [vMAJOR.MINOR.PATCH] [organization] [-h] [-s] [-v|-V] [-m|-M] [-d] [--path value] [--log directory]
	...
	Commands:
	  ...
	  version      Show VERSION or explicitly set a new organization version
